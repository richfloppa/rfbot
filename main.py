...
activity_options = ["what the hamze doin", "AI services are disabled.", "R!bot_help", "Gray = gay", "stop looking at my profile", "Caffy is a woman"]
activity_index = 0
...
AUTHORIZED_USER_IDS = [1235219802596048977, 563033118567563267, 1057936158992113754, 787226889369550859, 1116739769070788780, 743210144741195903, 1097679086719074416, 771041061169922118] # Replace with the authorized user's IDs
